...
async function main() {
  ...
  function detectRemoteDockerComposeCommand() {
    try {
      ...
      try {
        ...
        console.error('❌ Error: Neither docker compose nor docker-compose is available on remote server');
        return null;
      }
    }
  }
  ...
  function detectLocalDockerComposeCommand() {
    try {
      ...
      try {
        ...
        console.error('❌ Error: Neither docker compose nor docker-compose is available locally');
        return null;
      }
    }
  }
  ...
  async function followLogs() {
    ...
    if (!dockerCmd) {
      console.error('❌ Error: Docker compose command not available on remote server');
      return;
    }
  ...
  async function buildImage() {
    ...
    if (!dockerCmd) {
      console.error('❌ Error: Docker compose command not available locally');
      return;
    }
