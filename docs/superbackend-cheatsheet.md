...
This file is a compact, current snapshot of how to integrate and use `@intranefr/superbackend`.
...
Access via `@intranefr/superbackend.services.<name>`:
...
Access via `@intranefr/superbackend.models.<name>`:
...
```javascript
const { User, Asset, Organization } = require('@intranefr/superbackend').models;
